/*!\file parser.c
\brief fichier annexe : définit les fonctions permettant d'extraire les arguments d'une ligne de commande

Ces fonctions sont utilisées pour extraire les arguments de la ligne de commande envoyée vers les /proc. 
TODO : les éliminer du code car remplaçables par des sscanf bien sentis.
*/

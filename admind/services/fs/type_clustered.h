...
exa_error_code prepare_clustered_fs(admwrk_ctx_t *ctx,const char* fstype,const exa_nodeset_t* node_up);
exa_error_code unload_clustered_fs(admwrk_ctx_t *ctx,const char* fstype);

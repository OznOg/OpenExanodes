...
sub usage
{
  ...
  printf("  ZONESIZEMB (en Mo) sur le groupe désigné par son nom\n");
  printf("  GROUPNAME accolé au nom de la zone\n");
  printf(". Exemples :\n");
  printf("\t> zcreate multimedia:divx 50000\n\n");
  printf("\tCrée la zone \"divx\" de taille 50000 Mo sur le groupe\n");
